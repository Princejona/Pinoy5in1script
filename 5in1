...
apt install sudo
HOST='185.61.137.173';
USER='pinoyvpn3_mainpanel';
PASS='apu%kd6kbV5q';
DBNAME='pinoyvpn3_mainpanel';
PORT_TCP='1194';
PORT_UDP='110';
PORT_SSL='443';
API_LINK='https://pinoyvpn.qzz.io/api/authentication/premium';
API_KEY='Pinoy@2026';
...
echo "Made with love by: PinoyVpn Developer... " >> /root/.web/index.php
